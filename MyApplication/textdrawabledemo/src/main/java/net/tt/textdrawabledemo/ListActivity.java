package net.tt.textdrawabledemo;
...
import net.tt.textdrawabledemo.sample.DrawableProvider;
import net.tt.textdrawablelibrary.TextDrawable;
import net.tt.textdrawablelibrary.util.ColorGenerator;
