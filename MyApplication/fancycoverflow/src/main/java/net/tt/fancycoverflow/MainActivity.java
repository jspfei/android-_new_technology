...
import net.tt.fancycoverflow.example.SimpleExample;
import net.tt.fancycoverflow.example.ViewGroupExample;
import net.tt.fancycoverflow.example.ViewGroupReflectionExample;
import net.tt.fancycoverflow.example.XmlInflateExample;
    ...
    private static class ExampleAdapter extends BaseAdapter {
        ...
        public View getView(int i, View reusableView, ViewGroup viewGroup) {
            ...
            if (reusableView != null) {
                ...
                final int listItemPadding = context.getResources().getDimensionPixelSize(R.dimen.mainActivityListItemHeight);
