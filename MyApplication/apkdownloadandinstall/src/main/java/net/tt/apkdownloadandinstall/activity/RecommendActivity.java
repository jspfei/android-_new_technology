package net.tt.apkdownloadandinstall.activity;
...
import net.tt.apkdownloadandinstall.Constant;
import net.tt.apkdownloadandinstall.R;
import net.tt.apkdownloadandinstall.adapter.RecommendAdapter;
import net.tt.apkdownloadandinstall.bean.Product;
import net.tt.apkdownloadandinstall.service.DownloadService;
import net.tt.apkdownloadandinstall.utils.AssetsReadJsonManager;
import net.tt.apkdownloadandinstall.utils.FileUtils;
